...
Corner_area = 60 # write here the size of the virtual squares that receive wheel up and down event at the corner of your screen 

# Let's set up the commands
def volume_up():

    os.system("amixer set Master 2%+ & pid=$!")
...
#
  ...
  #
            ...
            if all( [event.root_x < 10000 , event.root_y > Screen_resolution[1] - Corner_area] ):
